        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
                ...
                <div class="-mt-10 text-gray-700">
                    <h2 class="font-bold text-lg">Referencia</h2>
                </div>
            </div>

            {{-- Peso, precio y carrito  de compras --}}
            <div>
                <h1 class="text-xl font-bold text-trueGray-700"></h1>
                <div class="flex">
                    <p class="text-gray-700">Peso: <a class="underline capitalize hover:text-orange-500"
                            href=""></a>{{ $product->weight }}</p>
                ...
                <p class="text-2xl font-semibold text-gray-700 my-4">Precio $ {{ $product->price }} </p>
